...
export const metadata: Metadata = {
	...
	keywords: [
		...
		"ลบภาพพื้นหลังฟรี",
		"ตัดฉากหลัง",
		"ลบพื้นหลังภาพฟรี ไม่จำกัด",
		"ตัดฉากหลังรูปด้วย AI ออนไลน์",
		"ลบพื้นหลังรูปสินค้า สำหรับขายของออนไลน์",
		"เว็บไซต์ลบพื้นหลังอัตโนมัติ ไม่ต้องสมัคร",
		"ลบพื้นหลังรูปโปรไฟล์ Facebook ฟรี",
		"แอปลบพื้นหลังรูป คน สิ่งของ",
		"ลบพื้นหลังรูปด่วน ไม่ใช้ Photoshop",
		"เครื่องมือตัดพื้นหลังรูปออนไลน์ มือถือ",
		"วิธีลบพื้นหลังภาพ jpg/png ฟรี",
	],
	openGraph: {
